...
class UpdateUserInputSet(InputSet):
    ...
    def set_UserData(self, value):
        """
        Set the value of the UserData input for this Choreo. ((required, json) A JSON string containing the updated user data. See documentation for formatting details.)
        """
