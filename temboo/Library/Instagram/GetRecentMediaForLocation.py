...
class GetRecentMediaForLocationInputSet(InputSet):
    ...
    def set_MaxID(self, value):
        """
        Set the value of the MaxID input for this Choreo. ((optional, integer) Returns media after this max_id.)
        """
    ...
    def set_MinID(self, value):
        """
        Set the value of the MinID input for this Choreo. ((optional, integer) Returns media before this min_id.)
        """
