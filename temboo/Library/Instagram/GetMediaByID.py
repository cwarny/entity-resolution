...
class GetMediaByIDInputSet(InputSet):
    ...
    def set_MediaID(self, value):
        """
        Set the value of the MediaID input for this Choreo. ((required, integer) The ID of the media object you want to retrieve. For example, a valid MediaID could be 3.)
        """
