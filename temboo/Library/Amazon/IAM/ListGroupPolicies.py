...
class ListGroupPolicies(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Amazon/IAM/ListGroupPolicies')
    ...
    def _make_result_set(self, result, path):
        return ListGroupPoliciesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListGroupPoliciesChoreographyExecution(session, exec_id, path)

class ListGroupPoliciesInputSet(InputSet):
    """
...
class ListGroupPoliciesResultSet(ResultSet):
    """
...
class ListGroupPoliciesChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListGroupPoliciesResultSet(response, path)
