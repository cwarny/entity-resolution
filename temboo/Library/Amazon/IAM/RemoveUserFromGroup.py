...
class RemoveUserFromGroup(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Amazon/IAM/RemoveUserFromGroup')
    ...
    def _make_result_set(self, result, path):
        return RemoveUserFromGroupResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return RemoveUserFromGroupChoreographyExecution(session, exec_id, path)

class RemoveUserFromGroupInputSet(InputSet):
    """
...
class RemoveUserFromGroupResultSet(ResultSet):
    """
...
class RemoveUserFromGroupChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return RemoveUserFromGroupResultSet(response, path)
