...
class GetBucketTagging(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Amazon/S3/GetBucketTagging')
    ...
    def _make_result_set(self, result, path):
        return GetBucketTaggingResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetBucketTaggingChoreographyExecution(session, exec_id, path)

class GetBucketTaggingInputSet(InputSet):
    """
...
class GetBucketTaggingResultSet(ResultSet):
    """
...
class GetBucketTaggingChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetBucketTaggingResultSet(response, path)
