...
class GetBucketCORS(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Amazon/S3/GetBucketCORS')
    ...
    def _make_result_set(self, result, path):
        return GetBucketCORSResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetBucketCORSChoreographyExecution(session, exec_id, path)

class GetBucketCORSInputSet(InputSet):
    """
...
class GetBucketCORSResultSet(ResultSet):
    """
...
class GetBucketCORSChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetBucketCORSResultSet(response, path)
