...
class GetFoodGoal(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Fitbit/Foods/GetFoodGoal')
    ...
    def _make_result_set(self, result, path):
        return GetFoodGoalResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetFoodGoalChoreographyExecution(session, exec_id, path)

class GetFoodGoalInputSet(InputSet):
    """
...
class GetFoodGoalResultSet(ResultSet):
    """
...
class GetFoodGoalChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetFoodGoalResultSet(response, path)
