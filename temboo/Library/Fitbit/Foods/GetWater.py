...
class GetWater(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Fitbit/Foods/GetWater')
    ...
    def _make_result_set(self, result, path):
        return GetWaterResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetWaterChoreographyExecution(session, exec_id, path)

class GetWaterInputSet(InputSet):
    """
...
class GetWaterResultSet(ResultSet):
    """
...
class GetWaterChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetWaterResultSet(response, path)
