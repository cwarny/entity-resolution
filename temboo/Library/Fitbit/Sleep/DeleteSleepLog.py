...
class DeleteSleepLog(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Fitbit/Sleep/DeleteSleepLog')
    ...
    def _make_result_set(self, result, path):
        return DeleteSleepLogResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DeleteSleepLogChoreographyExecution(session, exec_id, path)

class DeleteSleepLogInputSet(InputSet):
    """
...
class DeleteSleepLogResultSet(ResultSet):
    """
...
class DeleteSleepLogChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteSleepLogResultSet(response, path)
