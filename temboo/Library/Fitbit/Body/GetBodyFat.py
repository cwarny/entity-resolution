...
class GetBodyFat(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Fitbit/Body/GetBodyFat')
    ...
    def _make_result_set(self, result, path):
        return GetBodyFatResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetBodyFatChoreographyExecution(session, exec_id, path)

class GetBodyFatInputSet(InputSet):
    """
...
class GetBodyFatResultSet(ResultSet):
    """
...
class GetBodyFatChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetBodyFatResultSet(response, path)
