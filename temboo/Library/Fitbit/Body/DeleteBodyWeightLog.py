...
class DeleteBodyWeightLog(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Fitbit/Body/DeleteBodyWeightLog')
    ...
    def _make_result_set(self, result, path):
        return DeleteBodyWeightLogResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DeleteBodyWeightLogChoreographyExecution(session, exec_id, path)

class DeleteBodyWeightLogInputSet(InputSet):
    """
...
class DeleteBodyWeightLogResultSet(ResultSet):
    """
...
class DeleteBodyWeightLogChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteBodyWeightLogResultSet(response, path)
