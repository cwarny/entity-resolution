...
class GetInvites(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Fitbit/Social/GetInvites')
    ...
    def _make_result_set(self, result, path):
        return GetInvitesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetInvitesChoreographyExecution(session, exec_id, path)

class GetInvitesInputSet(InputSet):
    """
...
class GetInvitesResultSet(ResultSet):
    """
...
class GetInvitesChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetInvitesResultSet(response, path)
