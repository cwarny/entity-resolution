...
class GetGlucose(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Fitbit/Glucose/GetGlucose')
    ...
    def _make_result_set(self, result, path):
        return GetGlucoseResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetGlucoseChoreographyExecution(session, exec_id, path)

class GetGlucoseInputSet(InputSet):
    """
...
class GetGlucoseResultSet(ResultSet):
    """
...
class GetGlucoseChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetGlucoseResultSet(response, path)
