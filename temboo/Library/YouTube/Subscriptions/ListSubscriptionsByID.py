...
class ListSubscriptionsByID(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/YouTube/Subscriptions/ListSubscriptionsByID')
    ...
    def _make_result_set(self, result, path):
        return ListSubscriptionsByIDResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListSubscriptionsByIDChoreographyExecution(session, exec_id, path)

class ListSubscriptionsByIDInputSet(InputSet):
    """
...
class ListSubscriptionsByIDResultSet(ResultSet):
    """
...
class ListSubscriptionsByIDChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListSubscriptionsByIDResultSet(response, path)
