...
class DeleteSubscription(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/YouTube/Subscriptions/DeleteSubscription')
    ...
    def _make_result_set(self, result, path):
        return DeleteSubscriptionResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DeleteSubscriptionChoreographyExecution(session, exec_id, path)

class DeleteSubscriptionInputSet(InputSet):
    """
...
class DeleteSubscriptionResultSet(ResultSet):
    """
...
class DeleteSubscriptionChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteSubscriptionResultSet(response, path)
