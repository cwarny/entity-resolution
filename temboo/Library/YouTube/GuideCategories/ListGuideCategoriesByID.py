...
class ListGuideCategoriesByID(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/YouTube/GuideCategories/ListGuideCategoriesByID')
    ...
    def _make_result_set(self, result, path):
        return ListGuideCategoriesByIDResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListGuideCategoriesByIDChoreographyExecution(session, exec_id, path)

class ListGuideCategoriesByIDInputSet(InputSet):
    """
    ...
    def set_GuideCategoryID(self, value):
        """
        ...
        """
        InputSet._set_input(self, 'GuideCategoryID', value)
...
class ListGuideCategoriesByIDResultSet(ResultSet):
    """
...
class ListGuideCategoriesByIDChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListGuideCategoriesByIDResultSet(response, path)
