...
class ListMyChannels(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/YouTube/Channels/ListMyChannels')
    ...
    def _make_result_set(self, result, path):
        return ListMyChannelsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListMyChannelsChoreographyExecution(session, exec_id, path)

class ListMyChannelsInputSet(InputSet):
    """
...
class ListMyChannelsResultSet(ResultSet):
    """
...
class ListMyChannelsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListMyChannelsResultSet(response, path)
