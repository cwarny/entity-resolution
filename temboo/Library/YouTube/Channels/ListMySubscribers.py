...
class ListMySubscribers(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/YouTube/Channels/ListMySubscribers')
    ...
    def _make_result_set(self, result, path):
        return ListMySubscribersResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListMySubscribersChoreographyExecution(session, exec_id, path)

class ListMySubscribersInputSet(InputSet):
    """
...
class ListMySubscribersResultSet(ResultSet):
    """
...
class ListMySubscribersChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListMySubscribersResultSet(response, path)
