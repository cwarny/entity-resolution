...
class InsertPlaylist(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/YouTube/Playlists/InsertPlaylist')
    ...
    def _make_result_set(self, result, path):
        return InsertPlaylistResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return InsertPlaylistChoreographyExecution(session, exec_id, path)

class InsertPlaylistInputSet(InputSet):
    """
...
class InsertPlaylistResultSet(ResultSet):
    """
...
class InsertPlaylistChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return InsertPlaylistResultSet(response, path)
