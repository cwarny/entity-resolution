...
class ListPostsInputSet(InputSet):
    ...
    def set_UserID(self, value):
        """
        Set the value of the UserID input for this Choreo. ((optional, string) The Disqus User ID, for which active forum information will be retrieved.  If UserID is set, then Username must be null.)
        """
        InputSet._set_input(self, 'UserID', value)
    def set_Username(self, value):
        """
        Set the value of the Username input for this Choreo. ((optional, string) A Disqus username. If Username is being set, then UserID must be null.)
        """
