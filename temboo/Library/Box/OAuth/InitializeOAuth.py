...
class InitializeOAuth(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Box/OAuth/InitializeOAuth')
...
class InitializeOAuthResultSet(ResultSet):
    ...
    def get_AuthorizeURL(self):
        """
        Retrieve the value for the "AuthorizeURL" output from this Choreo execution. ((string) (Deprecated) Please refer to the AuthorizationURL output variable in your code. This output variable will be removed soon.)
        """
