...
#
# FinalizeOAuth
# Completes the OAuth 2 process by retrieving a RunKeeper access token for a user, after they have visited the authorization URL returned by the InitializeOAuth choreo and clicked "allow."
#
# Python version 2.6
#
###############################################################################
...
class FinalizeOAuth(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/RunKeeper/OAuth/FinalizeOAuth')
...
class FinalizeOAuthInputSet(InputSet):
    ...
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((required, string) The Client ID provided by RunKeeper after registering your application.)
        """
        InputSet._set_input(self, 'ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((required, string) The Client Secret provided by RunKeeper after registering your application.)
        """
