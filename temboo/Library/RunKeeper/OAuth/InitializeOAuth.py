...
class InitializeOAuth(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/RunKeeper/OAuth/InitializeOAuth')
...
class InitializeOAuthInputSet(InputSet):
    ...
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by RunKeeper after registering your application.)
        """
