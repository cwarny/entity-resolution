...
#
# FinalizeOAuth
# Completes the OAuth 2 process by retrieving a Bitly access token for a user, after they have visited the authorization URL returned by the InitializeOAuth choreo and clicked "allow."
#
# Python version 2.6
#
###############################################################################
...
class FinalizeOAuth(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Bitly/OAuth/FinalizeOAuth')
...
class FinalizeOAuthInputSet(InputSet):
    ...
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((required, string) The Client Secret provided by Bitly after registering your application.)
        """
...
class FinalizeOAuthResultSet(ResultSet):
    ...
    def get_Login(self):
        """
        Retrieve the value for the "Login" output from this Choreo execution. ((string) The Bitly username associated with the AccessToken.)
        """
        return self._output.get('Login', None)
