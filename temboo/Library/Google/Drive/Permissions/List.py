...
from temboo.outputs.Google.Drive.GooglePermissionList import GooglePermissionList
...
class ListResultSet(ResultSet):
    ...
    def getPermissionList(self):
        ...
        """
        return GooglePermissionList(self.getJSONFromString(self._output.get('Response', [])))
