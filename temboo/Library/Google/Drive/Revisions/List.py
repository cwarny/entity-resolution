...
from temboo.outputs.Google.Drive.GoogleRevisionList import GoogleRevisionList
...
class ListResultSet(ResultSet):
    ...
    def getRevisionList(self):
        ...
        """
        return GoogleRevisionList(self.getJSONFromString(self._output.get('Response', [])))
