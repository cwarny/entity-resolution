...
class InitializeOAuthInputSet(InputSet):
    ...
    def set_Scope(self, value):
        """
        Set the value of the Scope input for this Choreo. ((required, string) The OAuth scope that should be associated with the access token being requested. For example, to access Google Drive, you would specify the following scope: https://www.googleapis.com/auth/drive)
        """
