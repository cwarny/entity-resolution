...
from temboo.outputs.Google.Calendar.GoogleSettingList import GoogleSettingList
...
class GetAllSettingsResultSet(ResultSet):
    ...
    def getSettingList(self):
        ...
        """
        return GoogleSettingList(self.getJSONFromString(self._output.get('Response', [])))
