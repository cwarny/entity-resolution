...
from temboo.outputs.Google.Calendar.GoogleCalendarListEntry import GoogleCalendarListEntry
...
class GetAllCalendarsResultSet(ResultSet):
    ...
    def getCalendars(self):
        ...
        """
        return [GoogleCalendarListEntry(le) for le in self.getJSONFromString(self._output.get('Response', [])).get("items", [])]
