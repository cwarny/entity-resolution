...
class DeleteRecording(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Twilio/Recordings/DeleteRecording')
    ...
    def _make_result_set(self, result, path):
        return DeleteRecordingResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DeleteRecordingChoreographyExecution(session, exec_id, path)

class DeleteRecordingInputSet(InputSet):
    """
...
class DeleteRecordingResultSet(ResultSet):
    """
...
class DeleteRecordingChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteRecordingResultSet(response, path)
