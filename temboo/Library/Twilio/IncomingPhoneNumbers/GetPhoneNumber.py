...
class GetPhoneNumber(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Twilio/IncomingPhoneNumbers/GetPhoneNumber')
    ...
    def _make_result_set(self, result, path):
        return GetPhoneNumberResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetPhoneNumberChoreographyExecution(session, exec_id, path)

class GetPhoneNumberInputSet(InputSet):
    """
...
class GetPhoneNumberResultSet(ResultSet):
    """
...
class GetPhoneNumberChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetPhoneNumberResultSet(response, path)
