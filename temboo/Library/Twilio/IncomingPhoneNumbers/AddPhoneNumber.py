...
class AddPhoneNumber(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Twilio/IncomingPhoneNumbers/AddPhoneNumber')
    ...
    def _make_result_set(self, result, path):
        return AddPhoneNumberResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return AddPhoneNumberChoreographyExecution(session, exec_id, path)

class AddPhoneNumberInputSet(InputSet):
    """
...
class AddPhoneNumberResultSet(ResultSet):
    """
...
class AddPhoneNumberChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return AddPhoneNumberResultSet(response, path)
