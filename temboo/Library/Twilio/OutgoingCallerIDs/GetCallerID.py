...
class GetCallerID(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Twilio/OutgoingCallerIDs/GetCallerID')
    ...
    def _make_result_set(self, result, path):
        return GetCallerIDResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetCallerIDChoreographyExecution(session, exec_id, path)

class GetCallerIDInputSet(InputSet):
    """
...
class GetCallerIDResultSet(ResultSet):
    """
...
class GetCallerIDChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetCallerIDResultSet(response, path)
