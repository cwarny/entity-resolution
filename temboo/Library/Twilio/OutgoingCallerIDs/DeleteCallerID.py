...
class DeleteCallerID(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Twilio/OutgoingCallerIDs/DeleteCallerID')
    ...
    def _make_result_set(self, result, path):
        return DeleteCallerIDResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DeleteCallerIDChoreographyExecution(session, exec_id, path)

class DeleteCallerIDInputSet(InputSet):
    """
    ...
    def set_OutgoingCallerSID(self, value):
        ...
        """
        InputSet._set_input(self, 'OutgoingCallerSID', value)
...
class DeleteCallerIDResultSet(ResultSet):
    """
...
class DeleteCallerIDChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteCallerIDResultSet(response, path)
