...
class AddCallerID(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Twilio/OutgoingCallerIDs/AddCallerID')
    ...
    def _make_result_set(self, result, path):
        return AddCallerIDResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return AddCallerIDChoreographyExecution(session, exec_id, path)

class AddCallerIDInputSet(InputSet):
    """
...
class AddCallerIDResultSet(ResultSet):
    """
...
class AddCallerIDChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return AddCallerIDResultSet(response, path)
