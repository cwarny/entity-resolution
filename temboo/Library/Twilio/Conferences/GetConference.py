...
class GetConference(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Twilio/Conferences/GetConference')
    ...
    def _make_result_set(self, result, path):
        return GetConferenceResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetConferenceChoreographyExecution(session, exec_id, path)

class GetConferenceInputSet(InputSet):
    """
...
class GetConferenceResultSet(ResultSet):
    """
...
class GetConferenceChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetConferenceResultSet(response, path)
