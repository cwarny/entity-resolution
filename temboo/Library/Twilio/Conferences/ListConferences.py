...
class ListConferences(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Twilio/Conferences/ListConferences')
...
class ListConferencesInputSet(InputSet):
    ...
    def set_DateCreated(self, value):
        ...
        """
        InputSet._set_input(self, 'DateCreated', value)
    def set_DateUpdated(self, value):
        ...
        """
        InputSet._set_input(self, 'DateUpdated', value)
