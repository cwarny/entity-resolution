...
from temboo.outputs.Facebook.FacebookFriend import FacebookFriend
...
class FriendsResultSet(ResultSet):
    ...
    def getFriends(self):
        ...
        Get a friend object
        """
        return [FacebookFriend(le) for le in self.getJSONFromString(self._output.get('Response', [])).get("data", [])]
