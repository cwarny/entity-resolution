...
from temboo.outputs.Facebook.FacebookFeedItem import FacebookFeedItem
...
class ProfileFeedResultSet(ResultSet):
    ...
    def getFeedItems(self):
        ...
        """
        return [FacebookFeedItem(le) for le in self.getJSONFromString(self._output.get('Response', [])).get("data", [])]
