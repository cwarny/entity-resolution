...
from temboo.outputs.Facebook.FacebookLocationMetadata import FacebookLocationMetadata
...
class ObjectsWithLocationResultSet(ResultSet):
    ...
    def getLocationMetadata(self):
        """
        Get the user's location object
        """
        return [FacebookLocationMetadata(le) for le in self.getJSONFromString(self._output.get('Response', [])).get("data", [])]
