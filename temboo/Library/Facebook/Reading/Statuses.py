...
from temboo.outputs.Facebook.FacebookStatus import FacebookStatus
...
class StatusesResultSet(ResultSet):
    ...
    def getStatuses(self):
        ...
        """
        return [FacebookStatus(le) for le in self.getJSONFromString(self._output.get('Response', [])).get("data", [])]
