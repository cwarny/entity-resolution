...
from temboo.outputs.Facebook.FacebookCheckin import FacebookCheckin
...
class CheckinsResultSet(ResultSet):
    ...
    def getCheckins(self):
        ...
        """
        return [FacebookCheckin(le) for le in self.getJSONFromString(self._output.get('Response', [])).get("data", [])]
