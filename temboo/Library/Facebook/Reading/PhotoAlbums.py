...
from temboo.outputs.Facebook.FacebookPhotoAlbum import FacebookPhotoAlbum
...
class PhotoAlbumsResultSet(ResultSet):
    ...
    def getPhotoAlbums(self):
        ...
        """
        return [FacebookPhotoAlbum(le) for le in self.getJSONFromString(self._output.get('Response', [])).get("data", [])]
