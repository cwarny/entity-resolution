...
from temboo.outputs.Facebook.FacebookFriendRequest import FacebookFriendRequest
...
class FriendRequestsResultSet(ResultSet):
    ...
    def getFriendRequests(self):
        ...
        """
        return [FacebookFriendRequest(le) for le in self.getJSONFromString(self._output.get('Response', [])).get("data", [])]
