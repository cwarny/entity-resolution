...
from temboo.outputs.Facebook.FacebookVideo import FacebookVideo
...
class VideoUploadsResultSet(ResultSet):
    ...
    def getVideos(self):
        ...
        """
        return [FacebookVideo(le) for le in self.getJSONFromString(self._output.get('Response', [])).get("data", [])]
