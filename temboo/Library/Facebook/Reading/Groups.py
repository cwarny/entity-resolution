...
from temboo.outputs.Facebook.FacebookGroup import FacebookGroup
...
class GroupsResultSet(ResultSet):
    ...
    def getGroups(self):
        ...
        """
        return [FacebookGroup(le) for le in self.getJSONFromString(self._output.get('Response', [])).get("data", [])]
