...
from temboo.outputs.Facebook.FacebookVideoMetadata import FacebookVideoMetadata
...
class VideoTagsResultSet(ResultSet):
    ...
    def getVideoMetadata(self):
        ...
        Get a user's video
        """
        return [FacebookVideoMetadata(le) for le in self.getJSONFromString(self._output.get('Response', [])).get("data", [])]
