...
from temboo.outputs.Facebook.FacebookNote import FacebookNote
...
class NotesResultSet(ResultSet):
    ...
    def getNotes(self):
        ...
        Get the user's note
        """
        return [FacebookNote(le) for le in self.getJSONFromString(self._output.get('Response', [])).get("data", [])]
