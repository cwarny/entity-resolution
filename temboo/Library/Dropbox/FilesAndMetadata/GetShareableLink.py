...
from temboo.outputs.Dropbox.DropboxShareableLink import DropboxShareableLink
...
class GetShareableLink(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Dropbox/FilesAndMetadata/GetShareableLink')
...
class GetShareableLinkResultSet(ResultSet):
    ...
    def getShareablelink(self):
        ...
        """
        return DropboxShareableLink(self.getJSONFromString(self._output.get('Response', [])))
